...
class ModelTrainer(nn.Module):
    ...
    def set_data(self, train_data, valid_data, test_data):
        ...
        self.train_loader = dataloader.DataLoader(
            train_data, shuffle=True, batch_size=self.batch_size, num_workers=4
        )
        self.valid_loader = dataloader.DataLoader(
            valid_data, shuffle=False, batch_size=self.batch_size, num_workers=4
        )
        self.test_loader = dataloader.DataLoader(
            test_data, shuffle=False, batch_size=self.batch_size, num_workers=4
        )
